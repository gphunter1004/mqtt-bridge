...
type EdgeRepositoryInterface interface {
	...
	CreateEdge(edge *models.EdgeTemplate) (*models.EdgeTemplate, error)
	...
	UpdateEdge(edgeID uint, edge *models.EdgeTemplate) (*models.EdgeTemplate, error)

	// DeleteEdge deletes an edge template and cleans up associations
	DeleteEdge(edgeID uint) error
